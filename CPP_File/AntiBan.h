...
//
//
////inline const char * const BoolToString(const bool b){ return b ? "TRUE" : "FALSE"; }
//
...
//
//public:
//	BOOL DLLInLoadStatus;
//	BOOL DLLInMemStatus;
//	BOOL DLLInInInitializationStatus;
//
...
//	}Pinfo;
//
//	Process_INFO GetProcessInfo(std::string & PN, std::wstring DLLName);
//
