...
// sua phien ban, cap nhat build o day
#define APPVERSION sz__2_44
//#define DLLNAME "dinput8.dll"


extern bool g_bCheckConnectApp;
extern char g_szSessionID[126];
...
char* GetHardDiskSN(unsigned int diskIndex = 0);
...
//----MaHoa Kieu Cu -----------------------------------------------------------------------------------------
			...
			//strcpy(m_szUser, W2C(sEncryptedUsername.GetString()));
			//strcpy(m_szPass, W2C(sEncryptedPassword.GetString()));
			//strcpy(m_szSessionID, W2C(sEncryptedSessionID.GetString()));
...
//----MaHoa Kieu Cu -----------------------------------------------------------------------------------------
			...
			//strcpy(m_szUser, W2C(sDecryptedUsername.GetString()));
			//strcpy(m_szPass, W2C(sDecryptedPassword.GetString()));
			//strcpy(m_szSessionID, W2C(sDecryptedSessionID.GetString()));
